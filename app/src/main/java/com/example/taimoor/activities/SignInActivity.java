                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (user != null) {
                                    if (user.isEmailVerified()) {
                                        UserKeysSharedPreferences.getInstance().setString(Constants.USER_EMAIL,user.getEmail());
                                        UserKeysSharedPreferences.getInstance().setBoolean(Constants.USER_LOGGED_IN,true);
                                        System.out.println("Email Verified : " + user.isEmailVerified());
                                        Intent HomeActivity = new Intent(SignInActivity.this, MapsActivity.class);
